...
_Provenance: FlyDSL · rocprofv3 · MI350X SPX · 2026-06-09 · avg 49151.43617 ns/call_

## 1. Headline
flash_attn_dualwave_swp_gfx950_kernel_0: memory-bound, barrier-dominated (20.08% of 64.9% total stall) -> Raise occupancy by cutting register footprint
...
- total stall: 64.9% of 868044 latency cycles
...
- `s_waitcnt vmcnt(2)` @0x1abc (code_line 120, stall 34792) → /sgl-workspace/FlyDSL-lab/kernels/flash_attn_gfx950.py:192
...
- `buffer_store_dwordx2 v[32:33], v46, s[0:3], 0 offen` @0x5828 (code_line 2630, stall 31456) → /sgl-workspace/FlyDSL-lab/kernels/flash_attn_gfx950.py:300
- `s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)` @0x1960 (code_line 69, stall 26336) → /sgl-workspace/FlyDSL-lab/kernels/flash_attn_gfx950.py:192
...
- `buffer_load_dwordx4 v[6:9], v1, s[4:7], 0 offen` @0x1984 (code_line 75, stall 24628) → /sgl-workspace/FlyDSL-lab/kernels/flash_attn_gfx950.py:192
- `s_barrier` @0x5660 (code_line 2567, stall 14564) → /sgl-workspace/FlyDSL-lab/kernels/flash_attn_gfx950.py:192
...
### #2 — vmcnt (evidence: vmcnt.pct=14.01 @ /sgl-workspace/FlyDSL-lab/kernels/flash_attn_gfx950.py:192)
...
### #3 — barrier (evidence: barrier.pct=20.08 @ /sgl-workspace/FlyDSL-lab/kernels/flash_attn_gfx950.py:192)
